...
//    }
//
//#warning need to be finished compare
//    NSArray *sortArray = [contacts sortedArrayUsingComparator:^NSComparisonResult(NSString *hyphenateId1,
//                                                                                  NSString *hyphenateId2)
//    {
////        NSString *nickname1 = [[AgoraUserProfileManager sharedInstance] getNickNameWithUsername:hyphenateId1];
////        NSString *nickname2 = [[AgoraUserProfileManager sharedInstance] getNickNameWithUsername:hyphenateId2];
//        NSString *nickname1 = @"";
//        NSString *nickname2 = @"";
