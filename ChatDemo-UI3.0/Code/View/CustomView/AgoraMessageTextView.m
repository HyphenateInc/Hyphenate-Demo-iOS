...
@implementation AgoraMessageTextView
...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [AgoraMessageTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    return [AgoraMessageTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [AgoraMessageTextView maxCharactersPerLine]) + 1;
}
