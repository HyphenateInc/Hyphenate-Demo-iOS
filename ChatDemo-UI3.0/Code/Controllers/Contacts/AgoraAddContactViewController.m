...
@interface AgoraAddContactViewController ()<UITextFieldDelegate>
...
@implementation AgoraAddContactViewController
{
    UIButton *_addButton;
    CGFloat _addViewY;
}
...
- (void)addContact {
    ...
    if ([contactName isEqualToString:[AgoraChatClient sharedClient].currentUsername]) {
        self.textField.text = @"";
        _addButton.userInteractionEnabled = NO;
