...
- (UIView *)footerView
{
    if (_footerView == nil) {
        ...
        _footerView.backgroundColor = [UIColor HIPrimaryDarkColor];
        ...
        [_doneButton setBackgroundColor:[UIColor HIPrimaryDarkColor]];
...
- (void)loadDataSource
{
    ...
    NSArray *usernameList = [[EMClient sharedClient].contactManager getContacts];
