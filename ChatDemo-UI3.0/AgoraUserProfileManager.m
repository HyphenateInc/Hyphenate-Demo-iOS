...
#define kCURRENT_USERNAME [[AgoraChatClient sharedClient] currentUsername]
...
static AgoraUserProfileManager *sharedInstance = nil;
@interface AgoraUserProfileManager ()
{
...
@implementation AgoraUserProfileManager
