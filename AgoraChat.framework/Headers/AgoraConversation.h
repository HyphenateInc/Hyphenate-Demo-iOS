 ...
 */
typedef enum {
    AgoraConversationTypeChat  = 0,    /*! \~chinese 单聊会话 \~english one-to-one chat */
    AgoraConversationTypeGroupChat,    /*! \~chinese 群聊会话 \~english group chat  */
    AgoraConversationTypeChatRoom      /*! \~chinese 聊天室会话 \~english chat room  */
} AgoraConversationType;
 ...
 */
typedef enum {
    MessageSearchDirectionUp  = 0,    /*! \~chinese 向上搜索 \~english Search older messages */
    MessageSearchDirectionDown        /*! \~chinese 向下搜索 \~english Search newer messages */
 ...
 *  Chat conversation
 */
@interface AgoraConversation : NSObject
 ...
 *  Conversation type
 */
@property (nonatomic, assign, readonly) AgoraConversationType type;
 ...
 */
@property (nonatomic, strong, readonly) Message *latestMessage;
 ...
 *  Method AgoraConversation insertMessage:error: = AgoraChatManager importMsessage:completion: + update conversation latest message
 *
 *  @param aMessage 消息实例
 *  @param pError   错误信息
 *
 ...
 *  @param aDirection       Message search direction. 
                            MessageSearchDirectionUp: get aCount of messages before aMessageId; 
                            MessageSearchDirectionDown: get aCount of messages after aMessageId
 ...
 */
- (BOOL)insertMessage:(Message *)aMessage __deprecated_msg("Use -insertMessage:error:");
 ...
 */
- (BOOL)appendMessage:(Message *)aMessage __deprecated_msg("Use -appendMessage:error:");
 ...
 */
- (BOOL)updateMessage:(Message *)aMessage __deprecated_msg("Use -updateMessageChange:error:");
 ...
 *  @result Message instance
 */
- (Message *)loadMessageWithId:(NSString *)aMessageId __deprecated_msg("Use -loadMessageWithId:error:");
...
- (NSArray *)loadMoreMessagesFromId:(NSString *)aMessageId
                              limit:(int)aLimit
                          direction:(MessageSearchDirection)aDirection __deprecated_msg("Use -loadMessagesStartFromId:count:searchDirection:completion:");
...
- (NSArray *)loadMoreMessagesWithType:(MessageBodyType)aType
                            ...
                            direction:(MessageSearchDirection)aDirection __deprecated_msg("Use -loadMessagesWithType:timestamp:count:fromUser:searchDirection:completion:");
...
- (NSArray *)loadMoreMessagesContain:(NSString*)aKeywords
                              before:(long long)aTimestamp
                               limit:(int)aLimit
                                from:(NSString*)aSender
                           direction:(MessageSearchDirection)aDirection __deprecated_msg("Use -loadMessagesContainKeywords:timestamp:count:fromUser:searchDirection:completion:");
 ...
 *  @result Message instance
 */
- (Message *)latestMessageFromOthers __deprecated_msg("Use -lastReceivedMessage");
