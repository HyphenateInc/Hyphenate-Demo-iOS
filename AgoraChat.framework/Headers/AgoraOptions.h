 ...
 */
typedef enum {
    AgoraLogLevelDebug = 0, /*! \~chinese 输出所有日志 \~english Output all logs */
    AgoraLogLevelWarning,   /*! \~chinese 输出警告及错误 \~english Output warnings and errors */
    AgoraLogLevelError      /*! \~chinese 只输出错误 \~english Output errors only */
} AgoraLogLevel;
 ...
 *  SDK setting options
 */
@interface AgoraOptions : NSObject
