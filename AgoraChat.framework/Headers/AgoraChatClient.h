...
#import "AgoraMultiDevicesDelegate.h"
#import "AgoraOptions.h"
#import "AgoraPushOptions.h"
#import "AgoraError.h"
 ...
 */
typedef enum {
    AgoraServerCheckAccountValidation = 0,     /*! \~chinese 账号检查 \~english Valid account */
    AgoraServerCheckGetDNSListFromServer,      /*! \~chinese 获取服务列表检查 \~english Check get dns from server */
    AgoraServerCheckGetTokenFromServer,        /*! \~chinese 获取token检查 \~english Check get token from server */
    AgoraServerCheckDoLogin,                   /*! \~chinese 登录检查 \~english Check login mode */
    AgoraServerCheckDoLogout,                  /*! \~chinese 登出检查 \~english Check logout mode */
} AgoraServerCheckType;
 ...
 *  SDK setting options
 */
@property (nonatomic, strong, readonly) AgoraOptions *options;
 ...
 *  Contact Management
 */
@property (nonatomic, strong, readonly) id<IAgoraContactManager> contactManager;
 ...
 *  Group Management
 */
@property (nonatomic, strong, readonly) id<IAgoraGroupManager> groupManager;
 ...
 *  push Management
 */
@property (nonatomic, strong, readonly) id<IAgoraPushManager> pushManager;
/*!
 *  \~chinese
 *  SDK是否自动登录上次登录的账号
 *
...
@property (nonatomic, strong, readonly) id<IAgoraUserInfoManager> userInfoManager;
 ...
 *  @param pError           错误信息
 *
 *  @result 所有已经登录的设备信息<AgoraDeviceConfig>
 *
 *  \~english
 ...
 *  @param pError           Error
 *
 *  @result Information of logged in device <AgoraDeviceConfig>
 */
...
/*!
 *  \~chinese
 *  服务诊断接口，根据AgoraServerCheckType枚举的顺序依次诊断当前服务，并回调给开发者
 *  如果已经登录，默认使用登录账号
 *
 *  @param aUsername    用户名
 *  @param aPassword    密码
 ...
 *
 *  \~english
 *  Make a diagnose for service, Diagnosis of current services according to the order of AgoraServerCheckType enumeration, and callback for the developer
 ...
 */
@property (nonatomic, strong, readonly) AgoraPushOptions *pushOptions EM_DEPRECATED_IOS(3_1_0, 3_7_2, "Use -[IAgoraPushManager.pushOptions]");
 ...
 *  @result Error
 */
- (AgoraError *)setApnsNickname:(NSString *)aNickname EM_DEPRECATED_IOS(3_1_0, 3_7_2, "Use -[IAgoraPushManager:setApnsNickname:]");
...
- (void)updatePushNotifiationDisplayName:(NSString *)aDisplayName
                              completion:(void (^)(NSString *aDisplayName, AgoraError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_7_2, "Use -[IAgoraPushManager:updatePushNotifiationDisplayName:completion:]");
 ...
 */
- (AgoraPushOptions *)getPushOptionsFromServerWithError:(AgoraError **)pError EM_DEPRECATED_IOS(3_1_0, 3_7_2, "Use -[IAgoraPushManager:getPushOptionsFromServerWithError:]");
 ...
 *  @param aCompletionBlock The callback of completion block
 */
- (void)getPushNotificationOptionsFromServerWithCompletion:(void (^)(AgoraPushOptions *aOptions, AgoraError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_7_2, "Use -[IAgoraPushManager:getPushNotificationOptionsFromServerWithCompletion:]");
 ...
 *  @result Error
 */
- (AgoraError *)updatePushOptionsToServer EM_DEPRECATED_IOS(3_1_0, 3_7_2, "");
 ...
 *  @param aCompletionBlock The callback block of completion
 */
- (void)updatePushNotificationOptionsToServerWithCompletion:(void (^)(AgoraError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_7_2, "");
 ...
 *  @param aDelegate  Delegate
 */
- (void)addDelegate:(id<AgoraChatClientDelegate>)aDelegate EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -[IEMCallManager addDelegate:delegateQueue:]");
...
- (void)asyncRegisterWithUsername:(NSString *)aUsername
                         password:(NSString *)aPassword
                          ...
                          failure:(void (^)(AgoraError *aError))aFailureBlock EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -registerWithUsername:password:completion:");
...
- (void)asyncLoginWithUsername:(NSString *)aUsername
                      password:(NSString *)aPassword
                       success:(void (^)())aSuccessBlock
                       failure:(void (^)(AgoraError *aError))aFailureBlock EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -loginWithUsername:password:completion");
...
- (void)asyncLogout:(BOOL)aIsUnbindDeviceToken
            success:(void (^)())aSuccessBlock
            failure:(void (^)(AgoraError *aError))aFailureBlock EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -logout:completion:");
...
- (void)asyncBindDeviceToken:(NSData *)aDeviceToken
                     success:(void (^)())aSuccessBlock
                     failure:(void (^)(AgoraError *aError))aFailureBlock EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -registerForRemoteNotificationsWithDeviceToken:completion:");
...
- (void)asyncSetApnsNickname:(NSString *)aNickname
                     success:(void (^)())aSuccessBlock
                     failure:(void (^)(AgoraError *aError))aFailureBlock EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -updatePushNotifiationDisplayName:copletion");
...
- (void)asyncGetPushOptionsFromServer:(void (^)(AgoraPushOptions *aOptions))aSuccessBlock
                              failure:(void (^)(AgoraError *aError))aFailureBlock EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -getPushOptionsFromServerWithCompletion:");
...
- (void)asyncUpdatePushOptionsToServer:(void (^)())aSuccessBlock
                               failure:(void (^)(AgoraError *aError))aFailureBlock EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -updatePushNotificationOptionsToServerWithCompletion:");
...
- (void)asyncUploadLogToServer:(void (^)())aSuccessBlock
                       failure:(void (^)(AgoraError *aError))aFailureBlock EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -uploadDebugLogToServerWithCompletion:");
 ...
 *  Synchronization method will block the current thread
 *
 *  @param aDevice          device information <AgoraDeviceConfig>
 *  @param aUsername        Username
 *  @param aPassword        Password
 *
 *  @result Error
...
- (void)kickDevice:(AgoraDeviceConfig *)aDevice
          username:(NSString *)aUsername
          password:(NSString *)aPassword
        completion:(void (^)(AgoraError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use - kickDeviceWithUsername:password:resource:completion:");
@end
