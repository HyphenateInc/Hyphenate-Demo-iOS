 ...
 *  删除一组会话
 *
 *  @param aConversations       会话列表<AgoraConversation>
 *  @param aIsDeleteMessages    是否删除会话中的消息
 *  @param aCompletionBlock     完成的回调
 *
 *  \~english
 ...
 *  @param pError               AgoraError used for output.
 *
 *  @return    The result
 */
...
- (void)sendMessageReadAck:(Message *)aMessage
                completion:(void (^)(Message *aMessage, AgoraError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_3_0, 3_6_1, "Use -[IAgoraChatManager sendMessageReadAck:toUser:completion:]");
...
- (void)recallMessage:(Message *)aMessage
           completion:(void (^)(Message *aMessage, AgoraError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_3_0, 3_6_1, "Use -[IAgoraChatManager recallMessageWithMessageId:completion:]");
 ...
 *  @param aDelegate  Delegate
 */
- (void)addDelegate:(id<AgoraChatManagerDelegate>)aDelegate EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -[IAgoraChatManager addDelegate:delegateQueue:]");
 ...
 */
- (BOOL)updateMessage:(Message *)aMessage __deprecated_msg("Use -updateMessage:completion:");
 ...
 *  @param aMessage  Message instance
 */
- (void)asyncSendReadAckForMessage:(Message *)aMessage __deprecated_msg("Use -sendMessageReadAck:completion:");
...
- (void)asyncSendMessage:(Message *)aMessage
              ...
              completion:(void (^)(Message *message, AgoraError *error))aCompletion __deprecated_msg("Use -sendMessage:progress:completion:");
...
- (void)asyncResendMessage:(Message *)aMessage
                  progress:(void (^)(int progress))aProgressCompletion
                completion:(void (^)(Message *message, AgoraError *error))aCompletion __deprecated_msg("Use -resendMessage:progress:completion:");
...
- (void)asyncDownloadMessageThumbnail:(Message *)aMessage
                             progress:(void (^)(int progress))aProgressCompletion
                           completion:(void (^)(Message * message, AgoraError *error))aCompletion __deprecated_msg("Use -downloadMessageThumbnail:progress:completion:");
...
- (void)asyncDownloadMessageAttachments:(Message *)aMessage
                               progress:(void (^)(int progress))aProgressCompletion
                             completion:(void (^)(Message *message, AgoraError *error))aCompletion __deprecated_msg("Use -downloadMessageAttachment:progress:completion");
/*!
 *  \~chinese
