 ...
 *  Group operations
 */
@protocol IAgoraGroupManager <NSObject>
 ...
 *  获取用户所有群组
 *
 *  @result 群组列表<AgoraGroup>
 *
 *  \~english
 *  Get all groups
 *
 *  @result Group list<AgoraGroup>
 *
 */
...
/*!
 *  \~chinese
 *  加入一个公开群组，群类型应该是AgoraGroupStylePublicOpenJoin
 *  
 *  同步方法，会阻塞当前线程
 *
...
/*!
 *  \~chinese
 *  申请加入一个需批准的公开群组，群类型应该是AgoraGroupStylePublicJoinNeedApproval
 *
 *  同步方法，会阻塞当前线程
 *
 *  @param aGroupId    公开群组的ID
 ...
 *  @result Group list<AgoraGroup>
 */
- (NSArray *)getMyGroupsFromServerWithError:(AgoraError **)pError EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use -[IAgoraGroupManager getJoinedGroupsFromServerWithPage:pageSize:error:]");
 ...
 *
 */
- (void)getJoinedGroupsFromServerWithCompletion:(void (^)(NSArray *aList, AgoraError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use -[IAgoraGroupManager getJoinedGroupsFromServerWithPage:pageSize:completion:]");
...
- (AgoraGroup *)fetchGroupInfo:(NSString *)aGroupId
         includeMembersList:(BOOL)aIncludeMembersList
                      error:(AgoraError **)pError EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use -[IAgoraGroupManager getGroupSpecificationFromServerWithId:error:]");
...
- (void)getGroupSpecificationFromServerByID:(NSString *)aGroupID
                         includeMembersList:(BOOL)aIncludeMembersList
                                 completion:(void (^)(AgoraGroup *aGroup, AgoraError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use -[IAgoraGroupManager getGroupSpecificationFromServerWithId:completion:]");
...
- (NSArray *)fetchGroupBansList:(NSString *)aGroupId
                          error:(AgoraError **)pError EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use -[IAgoraGroupManager getGroupBlacklistFromServerWithId:pageNumber:pageSize:error:]");
...
- (void)getGroupBlackListFromServerByID:(NSString *)aGroupId
                             completion:(void (^)(NSArray *aList, AgoraError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use -[IAgoraGroupManager getGroupBlacklistFromServerWithId:pageNumber:pageSize:completion:]");
...
- (AgoraGroup *)destroyGroup:(NSString *)aGroupId
                    error:(AgoraError **)pError EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use -[IAgoraGroupManager destroyGroup:]");
 ...
 */
- (void)destroyGroup:(NSString *)aGroupId
          completion:(void (^)(AgoraGroup* aGroup, AgoraError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use -[IAgoraGroupManager destroyGroup:finishCompletion:]");
 ...
 *  @param aDelegate  Delegate
 */
- (void)addDelegate:(id<AgoraGroupManagerDelegate>)aDelegate EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -[IAgoraGroupManager addDelegate:delegateQueue:]");
...
- (void)asyncGetMyGroupsFromServer:(void (^)(NSArray *aList))aSuccessBlock
                           failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -getJoinedGroupsFromServerWithCompletion:");
...
- (void)asyncGetPublicGroupsFromServerWithCursor:(NSString *)aCursor
                                        pageSize:(NSInteger)aPageSize
                                         ...
                                         failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -getPublicGroupsFromServerWithCursor:pageSize:completion:");
...
- (void)asyncSearchPublicGroupWithId:(NSString *)aGroundId
                             ...
                             failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -searchPublicGroupWithId:completion:");
...
- (void)asyncCreateGroupWithSubject:(NSString *)aSubject
                        description:(NSString *)aDescription
                           invitees:(NSArray *)aInvitees
                            ...
                            setting:(AgoraGroupOptions *)aSetting
                            success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                            failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -createGroupWithSubject:description:invitees:message:setting:completion");
...
- (void)asyncFetchGroupInfo:(NSString *)aGroupId
         includeMembersList:(BOOL)aIncludeMembersList
                    success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                    failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -getGroupSpecificationFromServerByID:includeMembersList:completion:");
...
- (void)asyncFetchGroupBansList:(NSString *)aGroupId
                        ...
                        failure:(void (^)(AgoraError *aError))aFailureBlock  __deprecated_msg("Use -getGroupBlackListFromServerByID:completion:");
...
- (void)asyncAddOccupants:(NSArray *)aOccupants
           ...
           welcomeMessage:(NSString *)aWelcomeMessage
                  success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                  failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -addMembers:toGroup:message:completion:");
...
- (void)asyncRemoveOccupants:(NSArray *)aOccupants
                   fromGroup:(NSString *)aGroupId
                     success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                     failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -removeMembers:fromGroup:completion:");
...
- (void)asyncBlockOccupants:(NSArray *)aOccupants
                  fromGroup:(NSString *)aGroupId
                    success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                    failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -blockMembers:fromGroup:completion:");
...
- (void)asyncUnblockOccupants:(NSArray *)aOccupants
                     forGroup:(NSString *)aGroupId
                      success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                      failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -unblockMembers:fromGroup:completion:");
...
- (void)asyncChangeGroupSubject:(NSString *)aSubject
                       forGroup:(NSString *)aGroupId
                        success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                        failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -updateGroupSubject:forGroup:completion");
...
- (void)asyncChangeDescription:(NSString *)aDescription
                      forGroup:(NSString *)aGroupId
                       success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                       failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -updateDescription:forGroup:completion");
...
- (void)asyncLeaveGroup:(NSString *)aGroupId
                success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -leaveGroup:completion");
...
- (void)asyncDestroyGroup:(NSString *)aGroupId
                  success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                  failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -destroyGroup:completion");
...
- (void)asyncBlockGroup:(NSString *)aGroupId
                success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -blockGroup:completion:");
...
- (void)asyncUnblockGroup:(NSString *)aGroupId
                  success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                  failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -unblockGroup:completion");
...
- (void)asyncJoinPublicGroup:(NSString *)aGroupId
                     success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                     failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -joinPublicGroup:completion");
...
- (void)asyncApplyJoinPublicGroup:(NSString *)aGroupId
                          message:(NSString *)aMessage
                          success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                          failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -requestToJoinPublicGroup:message:completion:");
...
- (void)asyncAcceptJoinApplication:(NSString *)aGroupId
                         applicant:(NSString *)aUsername
                           ...
                           failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -approveJoinGroupRequest:sender:completion:");
...
- (void)asyncDeclineJoinApplication:(NSString *)aGroupId
                          applicant:(NSString *)aUsername
                             reason:(NSString *)aReason
                            success:(void (^)())aSuccessBlock
                            failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -declineJoinGroupRequest:sender:reason:completion:");
...
- (void)asyncAcceptInvitationFromGroup:(NSString *)aGroupId
                               inviter:(NSString *)aUsername
                               success:(void (^)(AgoraGroup *aGroup))aSuccessBlock
                               failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -acceptInvitationFromGroup:inviter:completion");
...
- (void)asyncDeclineInvitationFromGroup:(NSString *)aGroupId
                                inviter:(NSString *)aUsername
                                 reason:(NSString *)aReason
                                success:(void (^)())aSuccessBlock
                                failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -declineGroupInvitation:inviter:reason:completion:");
...
- (void)asyncIgnoreGroupPush:(NSString *)aGroupId
                      ignore:(BOOL)aIsIgnore
                     success:(void (^)())aSuccessBlock
                     failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -updatePushServiceForGroup:isPushEnabled:completion:");
