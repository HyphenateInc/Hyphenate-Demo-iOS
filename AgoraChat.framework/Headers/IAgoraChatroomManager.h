 ...
 *  @param pError   Error
 *
 *  @return Chat room list<AgoraChatroom>
 */
...
- (AgoraChatroom *)fetchChatroomInfo:(NSString *)aChatroomId
               includeMembersList:(BOOL)aIncludeMembersList
                            error:(AgoraError **)pError EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use -[IAgoraChatroomManager getChatroomSpecificationFromServerWithId:error:]");
...
- (void)getChatroomSpecificationFromServerByID:(NSString *)aChatroomId
                            includeMembersList:(BOOL)aIncludeMembersList
                                    completion:(void (^)(AgoraChatroom *aChatroom, AgoraError *aError))aCompletionBlock EM_DEPRECATED_IOS(3_1_0, 3_3_0, "Use -[IAgoraChatroomManager getChatroomSpecificationFromServerWithId:completion:]");
 ...
 *  @param aDelegate  Delegate
 */
- (void)addDelegate:(id<AgoraChatroomManagerDelegate>)aDelegate EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -[IAgoraChatroomManager addDelegate:delegateQueue:]");
 ...
 *  @return Chat room list<AgoraChatroom>
 */
- (NSArray *)getAllChatroomsFromServerWithError:(AgoraError **)pError __deprecated_msg("Use -getChatroomsFromServerWithPage");
 ...
 *
 */
- (void)getAllChatroomsFromServerWithCompletion:(void (^)(NSArray *aList, AgoraError *aError))aCompletionBlock __deprecated_msg("Use -getChatroomsFromServerWithPage");
...
- (void)asyncGetAllChatroomsFromServer:(void (^)(NSArray *aList))aSuccessBlock
                               failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -getAllChatroomsFromServerWithCompletion:");
...
- (void)asyncJoinChatroom:(NSString *)aChatroomId
                  ...
                  failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -joinChatroom:completion:");
...
- (void)asyncLeaveChatroom:(NSString *)aChatroomId
                   success:(void (^)(AgoraChatroom *aRoom))aSuccessBlock
                   failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -leaveChatroom:completion:");
...
- (void)asyncFetchChatroomInfo:(NSString *)aChatroomId
            includeMembersList:(BOOL)aIncludeMembersList
                       ...
                       failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -getChatroomSpecificationFromServerByID:includeMembersList:completion:");
@end
