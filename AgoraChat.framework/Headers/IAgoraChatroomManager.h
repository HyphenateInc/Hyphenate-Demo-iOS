 ...
 *  @param pError           出错信息
 *
 *  @result AgoraChatPageResult  聊天室列表在此搜索结果的list
 *
 *  \~english
 ...
 *  @param pError   Error
 *
 *  @result AgoraChatPageResult  Chatroom list is in the object's list
 */
 ...
 *  @param aInvitees            Members, without creator
 *  @param aMessage             Invitation message
 *  @param aMaxMembersCount     Max members count
 *  @param pError               Error
 *
 *  @result AgoraChatroom  Created chatroom
 */
 ...
 *  @param pError       Error
 *
 *  @result AgoraChatroom Joined chatroom
 */
 ...
 *  @param pError                Error
 *
 *  @result AgoraChatroom   Chatroom instance
 */
 ...
 *  @param pError   Error
 *
 *  @result Chat room NSArray<AgoraChatroom>
 */
