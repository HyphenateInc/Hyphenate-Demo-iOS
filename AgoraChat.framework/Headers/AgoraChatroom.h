 ...
 */
typedef enum{
    AgoraChatroomPermissionTypeNone   = -1,    /*! \~chinese 未知 \~english Unknown */
    AgoraChatroomPermissionTypeMember = 0,     /*! \~chinese 普通成员 \~english Normal member */
    AgoraChatroomPermissionTypeAdmin,          /*! \~chinese 聊天室管理员 \~english Chatroom admin */
    AgoraChatroomPermissionTypeOwner,          /*! \~chinese 聊天室拥有者 \~english Chatroom owner  */
