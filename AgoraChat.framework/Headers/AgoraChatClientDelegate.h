 ...
 */
typedef enum {
    AgoraConnectionConnected = 0,  /*! *\~chinese 已连接 *\~english Connected */
    AgoraConnectionDisconnected,   /*! *\~chinese 未连接 *\~english Disconnected */
 ...
 *  @param aConnectionState Current state
 */
- (void)didConnectionStateChanged:(AgoraConnectionState)aConnectionState __deprecated_msg("Use -connectionStateDidChange:");
 ...
 *  @param aError Error
 */
- (void)didAutoLoginWithError:(AgoraError *)aError __deprecated_msg("Use -autoLoginDidCompleteWithError:");
