 ...
 */
typedef enum{
    AgoraGroupPermissionTypeNone   = -1,    /*! \~chinese 未知 \~english Unknown */
    AgoraGroupPermissionTypeMember = 0,     /*! \~chinese 普通成员 \~english Normal member */
    AgoraGroupPermissionTypeAdmin,          /*! \~chinese 群组管理员 \~english Group admin */
    AgoraGroupPermissionTypeOwner,          /*! \~chinese 群主 \~english Group owner  */
}AgoraGroupPermissionType;
 ...
 */
@property (nonatomic, strong, readonly) AgoraGroupOptions *setting;
 ...
 */
@property (nonatomic, readonly) AgoraGroupPermissionType permissionType;
