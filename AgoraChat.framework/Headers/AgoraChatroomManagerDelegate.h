 ...
 *  @param aMutedMembers   Users to be Muted
 ...
 *
 *  @param aChatroom        Chatroom
 *  @param aMutedMembers    Users to be removed from MutedList
 */
- (void)chatroomMuteListDidUpdate:(AgoraChatroom *)aChatroom
 ...
 *
 *  @param aChatroom        Chatroom
 *  @param aMutedMembers    Users to be added whiteList
 */
 ...
 *
 *  @param aChatroom        Chatroom
 *  @param aMutedMembers    Users to be removed from whiteList
 */
- (void)chatroomWhiteListDidUpdate:(AgoraChatroom *)aChatroom
 ...
 *
 *  @param aChatroom    Chatroom
 *  @param aAdmin       User to be added adminList
 */
