 ...
 *  Contact Management
 */
@protocol IAgoraContactManager <NSObject>
 ...
 */
- (AgoraError *)addUserToBlackList:(NSString *)aUsername
               relationshipBoth:(BOOL)aBoth EM_DEPRECATED_IOS(3_2_3, 3_6_2, "Use -[IAgoraContactManager addUserToBlackList:]");
 ...
 *  @param aDelegate  Delegate
 */
- (void)addDelegate:(id<AgoraContactManagerDelegate>)aDelegate EM_DEPRECATED_IOS(3_1_0, 3_2_2, "Use -[IAgoraContactManager addDelegate:delegateQueue:]");
...
- (void)asyncGetContactsFromServer:(void (^)(NSArray *aList))aSuccessBlock
                           failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -getContactsFromServerWithCompletion:");
...
- (void)asyncAddContact:(NSString *)aUsername
                ...
                failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -addContact:message:completion:");
 ...
 *  @return Error
 */
- (AgoraError *)deleteContact:(NSString *)aUsername __deprecated_msg("Use -deleteContact:username:isDeleteConversation:");
 ...
 */
- (void)deleteContact:(NSString *)aUsername
           completion:(void (^)(NSString *aUsername, AgoraError *aError))aCompletionBlock __deprecated_msg("Use -deleteContact:username:isDeleteConversation:");
...
- (void)asyncDeleteContact:(NSString *)aUsername
                   success:(void (^)())aSuccessBlock
                   failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -deleteContact:completion:");
...
- (void)asyncGetBlackListFromServer:(void (^)(NSArray *aList))aSuccessBlock
                            failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -getBlackListFromServerWithCompletion:");
...
- (void)asyncAddUserToBlackList:(NSString *)aUsername
               relationshipBoth:(BOOL)aBoth
                        success:(void (^)())aSuccessBlock
                        failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -addUserToBlackList:completion:");
...
- (void)asyncRemoveUserFromBlackList:(NSString *)aUsername
                             success:(void (^)())aSuccessBlock
                             failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -removeUserFromBlackList:completion:");
...
- (void)asyncAcceptInvitationForUsername:(NSString *)aUsername
                                 success:(void (^)())aSuccessBlock
                                 failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -approveFriendRequestFromUser:completion:");
...
- (void)asyncDeclineInvitationForUsername:(NSString *)aUsername
                                  success:(void (^)())aSuccessBlock
                                  failure:(void (^)(AgoraError *aError))aFailureBlock __deprecated_msg("Use -declineFriendRequestFromUser:completion:");
