 ...
 */
typedef enum {
    AgoraDownloadStatusDownloading   = 0,  /*! \~chinese 正在下载 \~english Downloading */
    AgoraDownloadStatusSucceed,            /*! \~chinese 下载成功 \~english Succeed */
    AgoraDownloadStatusFailed,             /*! \~chinese 下载失败 \~english Failed */
    AgoraDownloadStatusPending,            /*! \~chinese 准备下载 \~english Pending */
    AgoraDownloadStatusSuccessed=AgoraDownloadStatusSucceed,   /*! \~chinese 旧版 \~english legacy */
} AgoraDownloadStatus;
 ...
 */
@property (nonatomic) AgoraDownloadStatus downloadStatus;
