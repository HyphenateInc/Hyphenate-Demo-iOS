...
@implementation EMMessageTextView
...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [EMMessageTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    return [EMMessageTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [EMMessageTextView maxCharactersPerLine]) + 1;
}
